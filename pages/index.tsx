...
import Video from 'src/docs/templates/includes/video'
import { classes } from 'src/docs/templates/snippets/classes'
            ...
            <div className="gatsby_listing-items">
              <div className="xt-row xt-row-stretch">
                <div className="gatsby_listing-column gatsby_home-main_scroll w-2/4 md:w-2/6">
                  <Link href="/intro" className={`xt-card p-3.5 sm:p-5 lg:p-6 ${classes.gatsbyFloat()}`}>
                ...
                <div className="gatsby_listing-column gatsby_home-main_scroll w-2/4 md:w-2/6">
                  <Link href="/components" className={`xt-card p-3.5 sm:p-5 lg:p-6 ${classes.gatsbyFloat()}`}>
                    <div className="xt-h5 text-base leading-tight mb-2 md:text-lg md:leading-tight md:mb-2 lg:text-xl lg:leading-tight lg:mb-2">
                      Components
                    </div>
                    <p className="xt-p text-xs leading-snug md:text-sm md:leading-snug opacity-[90%]">
                ...
                <div className="gatsby_listing-column gatsby_home-main_scroll w-2/4 md:w-2/6">
                  <Link href="/themes" className={`xt-card p-3.5 sm:p-5 lg:p-6 ${classes.gatsbyFloat()}`}>
                    <div className="xt-h5 text-base leading-tight mb-2 md:text-lg md:leading-tight md:mb-2 lg:text-xl lg:leading-tight lg:mb-2">
                      Themes
                    </div>
                    <p className="xt-p text-xs leading-snug md:text-sm md:leading-snug opacity-[90%]">
            ...
            <div className="xt-row xt-row-8 items-center justify-center">
              <div className="w-6/12 md:w-4/12 lg:w-3/12 gatsby_home-main_scroll">
                <a
                  ...
                  <Image className="inline-block w-full" src="/support/webgriffe.svg" loading="eager" alt="Webgriffe" width={300} height={58} />
                </a>
              </div>
            </div>
          </div>
...
export async function getStaticProps() {
  const assets = await ContentfulApi.getAssets();
  return {
    props: {
