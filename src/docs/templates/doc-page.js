...
import { markdownSlug } from 'src/docs/templates/snippets/markdown-slug'
import { useSiteContentful } from 'src/docs/templates/includes/siteContentful'
import SEO from 'src/docs/templates/seo'
import Layout from 'src/docs/templates/layout'
import Demo from 'src/docs/templates/demo/demo'
import DemoInline from 'src/docs/templates/demo/demo-inline'
