...
import Header from 'src/docs/templates/includes/header'
import HeaderHome from 'src/docs/templates/includes/header-home'
import Footer from 'src/docs/templates/includes/footer'
import DocHead from 'src/docs/templates/includes/doc-head'
import DocFoot from 'src/docs/templates/includes/doc-foot'
import DocFullscreen from 'src/docs/templates/includes/doc-fullscreen'
...
function Layout({ children, page, seo }) {
  ...
  useLayoutEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      require('src/docs/assets/scripts/app')
      require('src/docs/assets/scripts/demo').populateBlock()
      require('src/docs/assets/scripts/demo').makeDocument()
    }
  }, [])
  return (
    <>
